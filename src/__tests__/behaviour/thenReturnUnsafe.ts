 ...
 *
 * This is quite useful to test invalid parameters, or error cases, since you're able to pass
 * arguments that would normally not be accepted by the mocked function and verify
 * that your code handles them correctly.
 *
